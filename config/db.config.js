...
//criar função assíncrona de conexão - que chama o métido mongoose .connect (porque vai sair do server, ir até o banco de dados e depois voltar - retornará uma promise, e temos que aguardar o retorno dela)
async function connect() {
  try {
    ...
    console.log("Connected to DB: ", dbConnection.connection.name); // -> um console.log para confirmar que realmente estamos conectados com o banco de dados!
  } catch (error) {
